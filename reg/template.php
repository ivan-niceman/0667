            ...
            <ul class="nav navbar-nav menu_nav ml-auto mr-auto">
              ...
              <li class="nav-item submenu dropdown">
                ...
                <ul class="dropdown-menu">
                  ...
                  <li class="nav-item"><a class="nav-link" href="single-product.html">Каталог</a></li>
                  <li class="nav-item"><a class="nav-link" href="checkout.html">Оплата заказа</a></li>
                  <li class="nav-item"><a class="nav-link" href="confirmation.html">Подтверждение оплаты</a></li>
                  <li class="nav-item"><a class="nav-link" href="cart.html">Корзина покупок</a></li>
                </ul>
              </li>
              <li class="nav-item submenu dropdown">
              ...
              <li class="nav-item submenu dropdown">
                <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Кабинет</a>
                <ul class="dropdown-menu">
